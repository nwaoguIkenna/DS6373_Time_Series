...
dev.off()
plot(seq(1,508,1), CM$cmort, type = "l",xlim = c(0,508), ylab = "Cardiac Mortality", main = "last 30 Week Cardiac Mortality Forecast")
...
VARselect(cbind(CM$cmort, CM$part, CM$temp),lag.max = 10, season = 51, type = "both")
...
VARselect(cbind(CMsmall$cmort, CMsmall$part, CMsmall$temp),lag.max = 10, season = 51, type = "both")

CMortVAR = VAR(cbind(CMsmall$cmort, CMsmall$part, CMsmall$temp),season = 51, type = "both",p = 2)
